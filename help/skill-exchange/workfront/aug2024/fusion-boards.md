...
Ewan Hruska, Senior Customer Success Architect (ed ex cliente) e German Batiston, Product Manager, presso Adobe, vi guideranno attraverso uno scenario pratico di automazione dei flussi di lavoro utilizzando Workfront Fusion, una potente soluzione iPaaS (No-Code Integration Platform as a Service). Lo scenario? Automatizzare la creazione di una scheda standard, preconfigurata con tag e colonne. In questa sessione imparerai a:
