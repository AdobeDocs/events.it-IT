...
description: Una raccolta di registrazioni di eventi incentrata sull'utilizzo dei prodotti Enterprise di Adobe
mini-toc-levels: 0
...
# Registrazioni di eventi di Adobe Experience League {#events}

## Ad Experience League, l’apprendimento è un evento.

Continua a seguire gli eventi esclusivi e i webinar per ampliare il tuo apprendimento. Visita spesso questo spazio per visualizzare le registrazioni di eventi passati come Experience League LIVE, Skill Builder, Developers Live e altro ancora. Se vuoi registrarti per un evento imminente, dai un&#39;occhiata ai [prossimi eventi](https://%65xperienceleague.adobe.com/events/?lang=en) nell&#39;Experience League.
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Acrobat Analyzer Webinars">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/docs/events/acrobat-analyzer-webinars/overview.html" target="_blank" rel="referrer" title="Webinar su Acrobat Analyzer">Webinar su Acrobat Analyzer</a>
                    </p>
                    <p class="is-size-6">Partecipa ai webinar di Adobe Acrobat Analyzer per scoprire come l'intelligenza artificiale generativa trasforma i documenti in insights strutturati che automatizzano i flussi di lavoro e velocizzano il processo decisionale.</p>
                </div>
