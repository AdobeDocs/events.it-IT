...
* Experience Cloud configurazione automazione
* CIF - sito dimostrativo WKND Adventure
* CIF - Sostegno al Magento 2.4.4
* CIF - Miglioramenti ai Componenti core
* CIF - Arricchimento del prodotto per le pagine AEM
* Modernizzazione dell’SDK React dell’editor dell’SPA
